        ...
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Appointment">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.pending_appointment.fields.id') }}
                    </th>
                    <th>
                        {{ trans('cruds.pending_appointment.fields.client') }}
                    </th>
                    <th>
                        {{ trans('cruds.pending_appointment.fields.employee') }}
                    </th>
                    <th>
                        {{ trans('cruds.pending_appointment.fields.start_time') }}
                    </th>
                    <th>
                        {{ trans('cruds.pending_appointment.fields.finish_time') }}
                    </th>
                    {{--  <th>
                        {{ trans('cruds.pending_appointment.fields.price') }}
                    </th>  --}}
                    <th>
                        {{ trans('cruds.pending_appointment.fields.comments') }}
                    </th>
                    <th>
                        {{ trans('cruds.pending_appointment.fields.services') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
