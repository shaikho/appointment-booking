                        ...
                        @can('pending_appointment_access')
                            <li class="nav-item">
                                <a href="{{ route("admin.pendingappointments") }}" class="nav-link {{ request()->is('admin/appointments') || request()->is('admin/appointments/*') ? 'active' : '' }}">
                                    ...
                                    {{ trans('cruds.pending_appointment.menu_title') }}
                                </a>
                            </li>
                        @endcan
                        @can('approved_appointment_access')
                            <li class="nav-item">
                                <a href="{{ route("admin.approvedappointments") }}" class="nav-link {{ request()->is('admin/appointments') || request()->is('admin/appointments/*') ? 'active' : '' }}">
                                    ...
                                    {{ trans('cruds.approved_appointment.menu_title') }}
                                </a>
                            </li>
                        @endcan
                    </ul>
            ...
            {{-- @can('pending_appointment_access')
                <li class="nav-item">
                    <a href="{{ route("admin.pendingappointments") }}" class="nav-link {{ request()->is('admin/appointments') || request()->is('admin/appointments/*') ? 'active' : '' }}">
                        ...
                        {{ trans('cruds.pending_appointment.title') }}
                    </a>
                </li>
            @endcan
            @can('appointment_access')
